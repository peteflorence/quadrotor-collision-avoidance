...
Vector3 Trajectory::getTerminalStopPositionLASER(Scalar const& t) const {
  Vector3 position_end_of_trajectory = getPositionLASER(t);
  Vector3 velocity_end_of_trajectory = getVelocityLASER(t);
